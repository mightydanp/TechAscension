...
public class TAMaterials {
    ...
    //public static Supplier<Material> alexandrite, almandine, amethyst, andradite, anthracite, apatite, aquamarine, arsenopyrite, azurite, balasruby, barite, bastnasite,
    ...
    public static Supplier<Material> andesite, diorite, basalt, end_stone, granite, netherrack, stone;
    ...
    public static void commonInit() {
        ...
        //materialRegistry.register(diorite = new Material("diorite", 0x9dbfb1, new Pair<>(Ref.mod_id, DULL.getCodec())).setStoneLayerProperties(true, String.valueOf(Blocks.DIORITE.getRegistryName()), "minecraft:block/diorite"));
        //materialRegistry.register(end_stone = new Material("end_stone", 0xb8b09b, new Pair<>(Ref.mod_id, DULL.getCodec())).setStoneLayerProperties(true, String.valueOf(Blocks.END_STONE.getRegistryName()), "minecraft:block/end_stone"));
        //materialRegistry.register(granite = new Material("granite", 0xA26B56, new Pair<>(Ref.mod_id, DULL.getCodec())).setStoneLayerProperties(true, String.valueOf(Blocks.GRANITE.getRegistryName()), "minecraft:block/granite"));
