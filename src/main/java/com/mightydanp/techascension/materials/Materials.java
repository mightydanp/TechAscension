...
public class Materials {
    ...
    public static void commonInit() {
        ...
        limestone = RegistriesHandler.registerMaterial("limestone", () -> new Material("limestone", Icons.DULL.icon())
                ...
                .rockLayer.rockLayer(RockTypes.CHEMICAL_SEDIMENTARY.getType()).end()
        );
        ...
        quartzite = RegistriesHandler.registerMaterial("quartzite", () -> new Material("quartzite", Icons.QUARTZ.icon())
                ...
                .rockLayer.rockLayer(RockTypes.NON_FOLIATED_METAMORPHIC.getType()).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.NON_FOLIATED_METAMORPHIC.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        almandine = RegistriesHandler.registerMaterial("almandine", () -> new Material("almandine", Icons.ROUGH.icon())
                .physical.setColor(0xFF0000).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.FOLIATED_METAMORPHIC.getType(), RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        andradite = RegistriesHandler.registerMaterial("andradite", () -> new Material("andradite", Icons.ROUGH.icon())
                .physical.setColor(0x967800).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.NON_FOLIATED_METAMORPHIC.getType(), RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        apatite = RegistriesHandler.registerMaterial("apatite", () -> new Material("apatite", Icons.DULL.icon())
                .physical.setColor(0x78B4FA).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.FOLIATED_METAMORPHIC.getType(), RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        arsenopyrite = RegistriesHandler.registerMaterial("arsenopyrite", () -> new Material("arsenopyrite", Icons.DULL.icon())
                .physical.setColor(0xFAF01E).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.FOLIATED_METAMORPHIC.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        azurite = RegistriesHandler.registerMaterial("azurite", () -> new Material("azurite", Icons.DULL.icon())
                .physical.setColor(0x6DA4F7).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.VOLCANIC_IGNEOUS.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        balas_ruby = RegistriesHandler.registerMaterial("balas_ruby", () -> new Material("balas_ruby", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0xFF6464).end()
        ...
        barite = RegistriesHandler.registerMaterial("barite", () -> new Material("barite", Icons.DULL.icon())
                .physical.setColor(0xE6EBFF).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.VOLCANIC_IGNEOUS.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        bastnasite = RegistriesHandler.registerMaterial("bastnasite", () -> new Material("bastnasite", Icons.FINE.icon())
                .physical.setColor(0xC86E2D).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        beryllium = RegistriesHandler.registerMaterial("beryllium", () -> new Material("beryllium", Icons.METALLIC.icon())
                ...
                .thermal.setMeltingPoint(1560.0).setBoilingPoint(2742.0).end()
                .ore.setOre(OreTypes.ORE.oreType(), 16, RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        bixbite = RegistriesHandler.registerMaterial("bixbite", () -> new Material("bixbite", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0xFF5050).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.VOLCANIC_IGNEOUS.getType(), RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        black_eye = RegistriesHandler.registerMaterial("black_eye", () -> new Material("black_eye", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0x424442).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        blue_jasper = RegistriesHandler.registerMaterial("blue_jasper", () -> new Material("blue_jasper", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0x3C7C97).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        bromargyrite = RegistriesHandler.registerMaterial("bromargyrite", () -> new Material("bromargyrite", Icons.DULL.icon())
                .physical.setColor(0x5A2D0A).end()
        ...
        brown_limonite = RegistriesHandler.registerMaterial("brown_limonite", () -> new Material("brown_limonite", Icons.METALLIC.icon())
                .physical.setColor(0xC86400).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        cassiterite = RegistriesHandler.registerMaterial("cassiterite", () -> new Material("cassiterite", Icons.METALLIC.icon())
                .physical.setColor(0xDCDCDC).end()
        ...
        cats_eye = RegistriesHandler.registerMaterial("cats_eye", () -> new Material("cats_eye", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0x4D7451).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.FOLIATED_METAMORPHIC.getType(), RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        certus_quartz = RegistriesHandler.registerMaterial("certus_quartz", () -> new Material("certus_quartz", Icons.QUARTZ.icon())
                .physical.setColor(0xD2D2E6).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.VOLCANIC_IGNEOUS.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        chalcopyrite = RegistriesHandler.registerMaterial("chalcopyrite", () -> new Material("chalcopyrite", Icons.DULL.icon())
                .physical.setColor(0xA07828).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.VOLCANIC_IGNEOUS.getType(), RockTypes.FOLIATED_METAMORPHIC.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        chromite = RegistriesHandler.registerMaterial("chromite", () -> new Material("chromite", Icons.DULL.icon())
                .physical.setColor(0x23140F).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        cinnabar = RegistriesHandler.registerMaterial("cinnabar", () -> new Material("cinnabar", Icons.ROUGH.icon())
                .physical.setColor(0x960000).end()
        ...
        coal = RegistriesHandler.registerMaterial("coal", () -> new Material("coal", Icons.LIGNITE.icon())
                .physical.setColor(0x464646).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.ORGANIC_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        cobaltite = RegistriesHandler.registerMaterial("cobaltite", () -> new Material("cobaltite", Icons.METALLIC.icon())
                .physical.setColor(0x5050FA).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.FOLIATED_METAMORPHIC.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        diamond = RegistriesHandler.registerMaterial("diamond", () -> new Material("diamond", Icons.DIAMOND.icon())
                .physical.setColor(0xC8FFFF).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.VOLCANIC_IGNEOUS.getType(), RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        dioptase = RegistriesHandler.registerMaterial("dioptase", () -> new Material("dioptase", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0x00B4B4).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        dragon_eye = RegistriesHandler.registerMaterial("dragon_eye", () -> new Material("dragon_eye", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0xA45F53).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        emerald = RegistriesHandler.registerMaterial("emerald", () -> new Material("emerald", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0x50FF50).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.FOLIATED_METAMORPHIC.getType(), RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        ferberite = RegistriesHandler.registerMaterial("ferberite", () -> new Material("ferberite", Icons.DULL.icon())
                .physical.setColor(0x373223).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.VOLCANIC_IGNEOUS.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        galena = RegistriesHandler.registerMaterial("galena", () -> new Material("galena", Icons.DULL.icon())
                .physical.setColor(0x643C64).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.VOLCANIC_IGNEOUS.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        garnierite = RegistriesHandler.registerMaterial("garnierite", () -> new Material("garnierite", Icons.METALLIC.icon())
                .physical.setColor(0x32C846).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        glauconite = RegistriesHandler.registerMaterial("glauconite", () -> new Material("glauconite", Icons.DULL.icon())
                .physical.setColor(0x82B43C).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        goshenite = RegistriesHandler.registerMaterial("goshenite", () -> new Material("goshenite", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0xF0F0F0).end()
        ...
        hawks_eye = RegistriesHandler.registerMaterial("hawks_eye", () -> new Material("hawks_eye", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0x4C5E6D).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.FOLIATED_METAMORPHIC.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        heliodor = RegistriesHandler.registerMaterial("heliodor", () -> new Material("heliodor", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0xFFFF96).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        ilmenite = RegistriesHandler.registerMaterial("ilmenite", () -> new Material("ilmenite", Icons.METALLIC.icon())
                .physical.setColor(0x463732).end()
        ...
        iodine_salt = RegistriesHandler.registerMaterial("iodine_salt", () -> new Material("iodine_salt", Icons.DULL.icon())
                .physical.setColor(0xF0C8F0).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        iridium = RegistriesHandler.registerMaterial("iridium", () -> new Material("iridium", Icons.DULL.icon())
                ...
                .thermal.setMeltingPoint(2719.0).setBoilingPoint(4701.0).end()
                .ore.setOre(OreTypes.ORE.oreType(), 16, RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        lignite = RegistriesHandler.registerMaterial("lignite", () -> new Material("lignite", Icons.LIGNITE.icon())
                .physical.setColor(0x644646).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.ORGANIC_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        orange_sapphire = RegistriesHandler.registerMaterial("orange_sapphire", () -> new Material("orange_sapphire", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0xDC9632).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.NON_FOLIATED_METAMORPHIC.getType(), RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        purple_sapphire = RegistriesHandler.registerMaterial("purple_sapphire", () -> new Material("purple_sapphire", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0xDC32FF).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.NON_FOLIATED_METAMORPHIC.getType(), RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        pyrope = RegistriesHandler.registerMaterial("pyrope", () -> new Material("pyrope", Icons.METALLIC.icon())
                .physical.setColor(0x783264).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.FOLIATED_METAMORPHIC.getType(), RockTypes.VOLCANIC_IGNEOUS.getType(), RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        rainforest_jasper = RegistriesHandler.registerMaterial("rainforest_jasper", () -> new Material("rainforest_jasper", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0x817B37).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.VOLCANIC_IGNEOUS.getType(), RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        rock_salt = RegistriesHandler.registerMaterial("rock_salt", () -> new Material("rock_salt", Icons.FINE.icon())
                .physical.setColor(0xF0C8C8).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        salt = RegistriesHandler.registerMaterial("salt", () -> new Material("salt", Icons.FINE.icon())
                .physical.setColor(0xFAFAFA).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        thorium = RegistriesHandler.registerMaterial("thorium", () -> new Material("thorium", Icons.SHINY.icon())
                ...
                .thermal.setMeltingPoint(2115.0).setBoilingPoint(5061.0).end()
                .ore.setOre(OreTypes.ORE.oreType(), 16, RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        tiger_eye = RegistriesHandler.registerMaterial("tiger_eye", () -> new Material("tiger_eye", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0x8E743D).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.FOLIATED_METAMORPHIC.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        tiger_iron = RegistriesHandler.registerMaterial("tiger_iron", () -> new Material("tiger_iron", Icons.GEM_HORIZONTAL.icon())
                .physical.setColor(0x6A5642).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.FOLIATED_METAMORPHIC.getType(), RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        uraninite = RegistriesHandler.registerMaterial("uraninite", () -> new Material("uraninite", Icons.METALLIC.icon())
                .physical.setColor(0x232323).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.CHEMICAL_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
        
        uvarovite = RegistriesHandler.registerMaterial("uvarovite", () -> new Material("uvarovite", Icons.DIAMOND.icon())
                .physical.setColor(0xB4FFB4).end()
                .ore.setOre(OreTypes.GEM.oreType(), 8, RockTypes.NON_FOLIATED_METAMORPHIC.getType(), RockTypes.GENERIC.getType()).end()
        );
        ...
        zircon = RegistriesHandler.registerMaterial("zircon", () -> new Material("zircon", Icons.SHINY.icon())
                .physical.setColor(0x63181D).end()
                .ore.setOre(OreTypes.ORE.oreType(), 8, RockTypes.PLUTONIC_IGNEOUS.getType(), RockTypes.FOLIATED_METAMORPHIC.getType(), RockTypes.CLASTIC_SEDIMENTARY.getType(), RockTypes.GENERIC.getType()).end()
        );
