package mightydanp.techapi.common.world;
...
public class UndefinedContainerHelper {
    ...
    public static CompoundTag saveAllItems(CompoundTag p_18974_, List<ItemStack> p_18975_) {
        return saveAllItems(p_18974_, p_18975_, true);
    }

    public static CompoundTag saveAllItems(CompoundTag p_18977_, List<ItemStack> p_18978_, boolean p_18979_) {
