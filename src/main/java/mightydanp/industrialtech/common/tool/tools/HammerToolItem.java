 ...
 */
public class HammerToolItem extends ITToolItem {
    ...
    private static List<String> effectiveOn = new ArrayList<String>(){{
    ...
    public HammerToolItem() {
        super("hammer", effectiveOn, new Item.Properties().tab(ModItemGroups.tool_tab), craftingToolsNeeded, parts, disassembleTools);
        craftingToolsNeeded.put(String.valueOf(new ResourceLocation(Ref.mod_id, "hammer")), 1);

        //parts.put(ITMaterial.hammerHead, 1);
