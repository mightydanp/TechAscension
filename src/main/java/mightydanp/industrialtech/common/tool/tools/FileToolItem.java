 ...
 */
public class FileToolItem extends ITToolItem {
    ...
    public FileToolItem() {
        super("file", effectiveOn, new Item.Properties().tab(ModItemGroups.tool_tab), craftingToolsNeeded, parts, disassembleTools);
        craftingToolsNeeded.put(String.valueOf(new ResourceLocation(Ref.mod_id, "hammer")), 1);
        //parts.put(ITMaterial.fileHead, 1);
