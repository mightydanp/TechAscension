...
public class BlockRubberLog extends BlockBasic {
    ...
    public void onBlockModelBuild(Block block, AntimatterBlockStateProvider prov) {
        ModelFile rubberLog = prov.existing(References.ID, "block/rubber_log");
        ModelFile rubberLogEmpty = prov.existing(References.ID, "block/rubber_log_empty");
        ModelFile rubberLogFilled = prov.existing(References.ID, "block/rubber_log_filled");
