...
public class MachineRecipeLoader {
    ...
    public static void init() {
        ...
        IMPLOSION_COMPRESSING.RB().ii(IndustrialTechData.IridiumAlloyIngot.get(1)).io(IndustrialTechData.IridiumReinforcedPlate.get(1), DUST_TINY.get(DarkAsh, 4)).add(20, 30);
