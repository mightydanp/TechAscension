package mightydanp.industrialtech.common.loader;
...
import mightydanp.industrialtech.common.data.IndustrialTechData;
import mightydanp.industrialtech.common.tree.RubberTreeWorldGen;
...
//        new WorldGenStone("basalt_huge", BASALT, 1, 400, 150, 0, 120, OVERWORLD);
        ...
        WorldGenStoneLayer.add(IndustrialTechData.STONE, 4, OVERWORLD);
        WorldGenStoneLayer.add(IndustrialTechData.STONE, 1, OVERWORLD); //Ores
        WorldGenStoneLayer.add(IndustrialTechData.STONE, 1, OVERWORLD); //Ores
        WorldGenStoneLayer.add(IndustrialTechData.STONE, 1, OVERWORLD); //Ores
        WorldGenStoneLayer.add(IndustrialTechData.STONE, 1, OVERWORLD); //Ores
        
        WorldGenStoneLayer.add(IndustrialTechData.GRANITE_BLACK, 2, OVERWORLD);
        WorldGenStoneLayer.add(IndustrialTechData.GRANITE_BLACK, 1, OVERWORLD).forEach(w -> w.addOres(
            new StoneLayerOre(Cooperite, U32, 0, 16),
            new StoneLayerOre(Iridium, U64, 0, 8)
        ));

        WorldGenStoneLayer.add(IndustrialTechData.GRANITE_RED, 2, OVERWORLD);
        WorldGenStoneLayer.add(IndustrialTechData.GRANITE_RED, 1, OVERWORLD).forEach(w -> w.addOres(
            new StoneLayerOre(Pitchblende, U32, 0, 18),
            new StoneLayerOre(Uraninite, U32, 0, 16),
            new StoneLayerOre(Tantalite, U16, 20, 50)
        ));

        WorldGenStoneLayer.add(IndustrialTechData.KOMATIITE, 4, OVERWORLD);
        WorldGenStoneLayer.add(IndustrialTechData.KOMATIITE, 1, OVERWORLD).forEach(w -> w.addOres(
        ...
        WorldGenStoneLayer.add(IndustrialTechData.BASALT, 3, OVERWORLD);
        WorldGenStoneLayer.add(IndustrialTechData.BASALT, 1, OVERWORLD); //Ores
        WorldGenStoneLayer.add(IndustrialTechData.BASALT, 1, OVERWORLD); //Ores

        WorldGenStoneLayer.add(IndustrialTechData.MARBLE, 4, OVERWORLD);
        WorldGenStoneLayer.add(IndustrialTechData.MARBLE, 1, OVERWORLD); //Ores

        WorldGenStoneLayer.add(IndustrialTechData.LIMESTONE, 3, OVERWORLD);
        WorldGenStoneLayer.add(IndustrialTechData.LIMESTONE, 1, OVERWORLD); //Ores
        WorldGenStoneLayer.add(IndustrialTechData.LIMESTONE, 1, OVERWORLD); //Ores

        WorldGenStoneLayer.add(IndustrialTechData.GREEN_SCHIST, 1, OVERWORLD);
        WorldGenStoneLayer.add(IndustrialTechData.GREEN_SCHIST, 1, OVERWORLD); //Ores

        WorldGenStoneLayer.add(IndustrialTechData.BLUE_SCHIST, 1, OVERWORLD);
        WorldGenStoneLayer.add(IndustrialTechData.BLUE_SCHIST, 1, OVERWORLD); //Ores

        WorldGenStoneLayer.add(IndustrialTechData.KIMBERLITE, 3, OVERWORLD);
        WorldGenStoneLayer.add(IndustrialTechData.KIMBERLITE, 1, OVERWORLD); //Ores

        WorldGenStoneLayer.add(IndustrialTechData.QUARTZITE, 4, OVERWORLD);
        WorldGenStoneLayer.add(IndustrialTechData.QUARTZITE, 1, OVERWORLD); //Ores

        WorldGenStoneLayer.add(IndustrialTechData.GRANITE, 3, OVERWORLD);
        WorldGenStoneLayer.add(IndustrialTechData.GRANITE, 1, OVERWORLD); //Ores
        WorldGenStoneLayer.add(IndustrialTechData.GRANITE, 1, OVERWORLD); //Ores

        WorldGenStoneLayer.add(IndustrialTechData.DIORITE, 3, OVERWORLD);
        WorldGenStoneLayer.add(IndustrialTechData.DIORITE, 1, OVERWORLD); //Ores
        WorldGenStoneLayer.add(IndustrialTechData.DIORITE, 1, OVERWORLD); //Ores

        WorldGenStoneLayer.add(IndustrialTechData.ANDESITE, 4, OVERWORLD);
        WorldGenStoneLayer.add(IndustrialTechData.ANDESITE, 1, OVERWORLD); //Ores
        WorldGenStoneLayer.add(IndustrialTechData.ANDESITE, 1, OVERWORLD); //Ores
        ...
        WorldGenStoneLayer.addCollision(IndustrialTechData.BASALT.getState(), IndustrialTechData.LIMESTONE.getState(),
