...
import static mightydanp.industrialtech.common.data.RecipeMaps.*;
...
public class MaterialRecipeLoader {
    ...
    public static int mixedOreYield = References.mixedOreYieldsTwoThirdsPureOre ? 2 : 3;
...
//            }
        ...
        CRUSHED.all().forEach(m -> {
            ...
            if (m.has(GEM)) { //Gem Specific Recipes
                ...
                ItemStack aNonDirectSmeltingOutput = References.mixedOreYieldsTwoThirdsPureOre ? NUGGET.get(m, 6) : INGOT.get(m.getDirectSmeltInto(), 1);
