...
public class CampfireBlockOverride extends ContainerBlock implements IWaterLoggable {
    ...
    public CampfireBlockOverride(boolean p_i241174_1_, int p_i241174_2_) {
        super(AbstractBlock.Properties.of(Material.WOOD));
        this.spawnParticles = p_i241174_1_;
        this.fireDamage = p_i241174_2_;
        this.registerDefaultState(this.stateDefinition.any().setValue(LIT, Boolean.valueOf(false)).setValue(SIGNAL_FIRE, Boolean.valueOf(false)).setValue(WATERLOGGED, Boolean.valueOf(false)).setValue(FACING, Direction.NORTH));
    }
