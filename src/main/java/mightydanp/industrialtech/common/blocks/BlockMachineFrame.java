...
/**
 * Created by MightyDanp on 8/21/2020.
 */
public class BlockMachineFrame extends BlockDynamic implements IAntimatterObject, IItemBlockProvider, IColorHandler {

    protected Machine<?> type;
    protected Tier tier;

    public BlockMachineFrame(Machine<?> type, Tier tier) {
