...
public class SlotConveyor extends SlotItemHandler {
    ...
    public SlotConveyor(IItemHandler stackHandler, int index, int x, int y) {
        ...
        addValidSlotItem(ConveyorLV.asItem());
        addValidSlotItem(ConveyorMV.asItem());
        addValidSlotItem(ConveyorHV.asItem());
        addValidSlotItem(ConveyorEV.asItem());
        addValidSlotItem(ConveyorIV.asItem());
    }
