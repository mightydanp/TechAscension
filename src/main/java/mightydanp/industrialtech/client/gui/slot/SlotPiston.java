 ...
 */
public class SlotPiston extends SlotItemHandler {
    private static List<Item> validItems  = new ArrayList<>();

    public SlotPiston(IItemHandler stackHandler, int index, int x, int y) {
        super(stackHandler, index, x, y);
        addValidSlotItem(PistonLV);
        addValidSlotItem(PistonMV);
        addValidSlotItem(PistonHV);
        addValidSlotItem(PistonEV);
        addValidSlotItem(PistonIV);
    }
