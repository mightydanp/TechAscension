...
public class SlotSensor extends SlotItemHandler {
    private static List<Item> validItems  = new ArrayList<Item>();

    public SlotSensor(IItemHandler stackHandler, int index, int x, int y) {
        super(stackHandler, index, x, y);
        addValidSlotItem(SensorLV);
        addValidSlotItem(SensorMV);
        addValidSlotItem(SensorHV);
        addValidSlotItem(SensorEV);
        addValidSlotItem(SensorIV);
    }
