...
public class ResinHoleModel extends Model {
    ...
    public void renderToBuffer(MatrixStack matrixStack, IVertexBuilder iVertexBuilder, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        if (holeTileEntity.getLevel() != null) {
            ...
            //resin_0
            RenderHelper.renderUVCube(matrixStack, iVertexBuilder, packedLight, packedOverlay, resinColor.getRed(), resinColor.getGreen(), resinColor.getBlue(), alpha, texHeight, texWidth,
                    new AxisAlignedBB(7, 7, 16, 9, 10, 0.5),
            ...
            //resin_1
            RenderHelper.renderUVCube(matrixStack, iVertexBuilder, packedLight, packedOverlay, resinColor.getRed(), resinColor.getGreen(), resinColor.getBlue(), alpha, texHeight, texWidth,
                    new AxisAlignedBB(6, 7, 16, 7, 9, 0.5),
            ...
            //resin_2
            RenderHelper.renderUVCube(matrixStack, iVertexBuilder, packedLight, packedOverlay, resinColor.getRed(), resinColor.getGreen(), resinColor.getBlue(), alpha, texHeight, texWidth,
                    new AxisAlignedBB(9, 3.99, 16, 10.01, 9, 0.5),
            ...
            //resin_3
            RenderHelper.renderUVCube(matrixStack, iVertexBuilder, packedLight, packedOverlay, resinColor.getRed(), resinColor.getGreen(), resinColor.getBlue(), alpha, texHeight, texWidth,
                    new AxisAlignedBB(8, 6, 16, 9, 7, 0.5),
            ...
            //resin_4
            RenderHelper.renderUVCube(matrixStack, iVertexBuilder, packedLight, packedOverlay, resinColor.getRed(), resinColor.getGreen(), resinColor.getBlue(), alpha, texHeight, texWidth,
                    new AxisAlignedBB(8, 2, 16, 9, 4, 0.5),
            ...
            //resin_5
            RenderHelper.renderUVCube(matrixStack, iVertexBuilder, packedLight, packedOverlay, resinColor.getRed(), resinColor.getGreen(), resinColor.getBlue(), alpha, texHeight, texWidth,
                    new AxisAlignedBB(10, 1, 16, 11, 4, 0.5),
            ...
            //resin_6
            RenderHelper.renderUVCube(matrixStack, iVertexBuilder, packedLight, packedOverlay, resinColor.getRed(), resinColor.getGreen(), resinColor.getBlue(), alpha, texHeight, texWidth,
                    new AxisAlignedBB(7, 1, 16, 8, 2, 0.5),
