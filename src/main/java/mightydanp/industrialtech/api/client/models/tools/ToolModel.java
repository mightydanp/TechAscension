...
public class ToolModel extends CompositeModel {
    ...
    public TextureAtlasSprite getParticleIcon() {
        return particleModel.getParticleIcon();
    }
        ...
        public IBakedModel resolve(IBakedModel originalModel, ItemStack stack, @Nullable ClientWorld world, @Nullable LivingEntity entity) {
            ...
            for (int i = 0; i < partNames.length; i++) {
                ...
                if (part != null) {
                    ...
                    IBakedModel override = part.getOverrides().resolve(part, stack, world, entity);
            ...
            // TODO: modifier model
            return cache.computeIfAbsent(new QuickHash(hashKey), (key) -> new ToolModel(model.isGui3d(), model.usesBlockLight(), model.useAmbientOcclusion(), model.particleModel, bakedParts.build(), originalTransform, this));
        }
    }
