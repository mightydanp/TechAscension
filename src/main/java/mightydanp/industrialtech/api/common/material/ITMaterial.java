...
import mightydanp.industrialtech.api.common.resources.asset.data.BlockStateData;
import mightydanp.industrialtech.api.common.resources.asset.data.ItemModelData;
import mightydanp.industrialtech.api.common.resources.asset.data.LangData;
    ...
    public ITMaterial save() {
        ...
        for(IMaterialFlag flag : materialFlags){
            if(flag == ORE || flag == GEM || flag == STONE_LAYER){
                if(flag == STONE_LAYER){
                    ...
                    DataPackRegistry.saveBlockTagData(DataPackRegistry.getBlockTagData("rocks/" + name).isVanilla(false).addValue(rockBlock.getId()));
                    DataPackRegistry.saveBlockTagData(DataPackRegistry.getBlockTagData("rocks").isVanilla(false).addValue(rockBlock.getId()));
                    //
                    ...
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("rocks/" + name).isVanilla(false).addValue(rockItemBlock.getId()));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("rocks").isVanilla(false).addValue(rockItemBlock.getId()));
                    //
                    ...
                    DataPackRegistry.saveBlockTagData(DataPackRegistry.getBlockTagData("thin_slabs/" + name).isVanilla(false).addValue(rockBlock.getId()));
                    DataPackRegistry.saveBlockTagData(DataPackRegistry.getBlockTagData("thin_slabs").isVanilla(false).addValue(rockBlock.getId()));
                    //
                    ...
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("thin_slabs/" + name).isVanilla(false).addValue(rockItemBlock.getId()));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("thin_slabs").isVanilla(false).addValue(rockItemBlock.getId()));
                    //
                ...
                for(ITMaterial  stoneLayer : stoneLayerList){
                    ...
                    if(flag == ORE || flag == GEM) {
                        ...
                        DataPackRegistry.saveBlockTagData(DataPackRegistry.getBlockTagData("ores/" + name).isVanilla(false).addValue(ore.getId()));
                        DataPackRegistry.saveBlockTagData(DataPackRegistry.getBlockTagData("ores").isVanilla(false).addValue(ore.getId()));
                        oreList.add(ore);
                        //
                        ...
                        DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("ores/" + name).isVanilla(false).addValue(oreItemR.getId()));
                        DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("ores").isVanilla(false).addValue(oreItemR.getId()));
                        ...
                        DataPackRegistry.saveBlockTagData(DataPackRegistry.getBlockTagData("small_ores/" + stoneLayer.name + "_" + name).isVanilla(false).addValue(smallOreBlockR.getId()));
                        DataPackRegistry.saveBlockTagData(DataPackRegistry.getBlockTagData("small_ores").isVanilla(false).addValue(smallOreBlockR.getId()));
                        ...
                        DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("small_ores/" + stoneLayer.name + "_" + name).isVanilla(false).addValue(smallOreBlockR.getId()));
                        DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("small_ores").isVanilla(false).addValue(smallOreBlockR.getId()));
                        ...
                        DataPackRegistry.saveBlockTagData(DataPackRegistry.getBlockTagData("dense_ores/" + stoneLayer.name + "_" + name).isVanilla(false).addValue(denseOreBlockR.getId()));
                        DataPackRegistry.saveBlockTagData(DataPackRegistry.getBlockTagData("dense_ores").isVanilla(false).addValue(denseOreBlockR.getId()));
                        ...
                        DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("dense_ores/" + stoneLayer.name + "_" + name).isVanilla(false).addValue(denseOreItemR.getId()));
                        DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("dense_ores").isVanilla(false).addValue(denseOreItemR.getId()));
                ...
                if(flag == ORE || flag == GEM){
                    ...
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("crushed_ores/" + name).isVanilla(false).addValue(crushedOre.getId()));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("crushed_ores").isVanilla(false).addValue(crushedOre.getId()));
                    ...
                    purifiedOre = RegistryHandler.ITEMS.register("purified_" + name + "_ore", ()-> new OreProductsItem(new Item.Properties()
                            .tab(ModItemGroups.ore_products_tab), boilingPoint, meltingPoint, symbol));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("purified_ores/" + name).isVanilla(false).addValue(purifiedOre.getId()));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("purified_ores").isVanilla(false).addValue(purifiedOre.getId()));
                    ...
                    centrifugedOre = RegistryHandler.ITEMS.register("centrifuged_" + name + "_ore", ()-> new OreProductsItem(new Item.Properties()
                            .tab(ModItemGroups.ore_products_tab), boilingPoint, meltingPoint, symbol));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("centrifuged_ores/" + name).isVanilla(false).addValue(centrifugedOre.getId()));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("centrifuged_ores").isVanilla(false).addValue(centrifugedOre.getId()));
                ...
                if(flag == GEM){
                    ...
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("gems/" + name).isVanilla(false).addValue(gem.getId()));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("gems").isVanilla(false).addValue(gem.getId()));
                    ...
                    chippedGem = RegistryHandler.ITEMS.register("chipped_" + name + "_gem", ()-> new GemItem(new Item.Properties()
                            .tab(ModItemGroups.gem_tab), symbol));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("chipped_gems/" + name).isVanilla(false).addValue(chippedGem.getId()));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("chipped_gems").isVanilla(false).addValue(chippedGem.getId()));
                    ...
                    flawedGem = RegistryHandler.ITEMS.register("flawed_" + name + "_gem", ()-> new GemItem(new Item.Properties()
                            .tab(ModItemGroups.gem_tab), symbol));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("flawed_gems/" + name).isVanilla(false).addValue(flawedGem.getId()));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("flawed_gems").isVanilla(false).addValue(flawedGem.getId()));
                    ...
                    flawlessGem = RegistryHandler.ITEMS.register(  "flawless_" + name + "_gem", ()-> new GemItem(new Item.Properties()
                            .tab(ModItemGroups.gem_tab), symbol));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("flawless_gems/" + name).isVanilla(false).addValue(flawlessGem.getId()));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("flawless_gems").isVanilla(false).addValue(flawlessGem.getId()));
                    ...
                    legendaryGem = RegistryHandler.ITEMS.register("legendary_" + name + "_gem", ()-> new GemItem(new Item.Properties()
                            .tab(ModItemGroups.gem_tab), symbol));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("legendary_gems/" + name).isVanilla(false).addValue(legendaryGem.getId()));
                    DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("legendary_gems").isVanilla(false).addValue(legendaryGem.getId()));
                ...
                dust = RegistryHandler.ITEMS.register("" + name + "_dust", ()->  new OreProductsItem(new Item.Properties()
                        .tab(ModItemGroups.ore_products_tab), boilingPoint, meltingPoint, symbol));
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("dusts/" + name).isVanilla(false).addValue(dust.getId()));
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("dusts").isVanilla(false).addValue(dust.getId()));
                ...
                smallDust = RegistryHandler.ITEMS.register("small_" + name + "_dust", ()-> new OreProductsItem(new Item.Properties()
                        .tab(ModItemGroups.ore_products_tab), boilingPoint, meltingPoint, symbol));
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("small_dusts/" + name).isVanilla(false).addValue(smallDust.getId()));
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("small_dusts").isVanilla(false).addValue(smallDust.getId()));
                ...
                tinyDust = RegistryHandler.ITEMS.register("tiny_" + name + "_dust", ()-> new OreProductsItem(new Item.Properties()
                        .tab(ModItemGroups.ore_products_tab), boilingPoint, meltingPoint, symbol));
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("tiny_dusts/" + name).isVanilla(false).addValue(tinyDust.getId()));
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("tiny_dusts").isVanilla(false).addValue(tinyDust.getId()));
        ...
        for(IToolPart flag : toolParts){
            if(flag == TOOL_HEAD){
                ...
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("dull_pickaxe_heads/" + name).isVanilla(false).addValue(dullPickaxeHead.getId()));
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("dull_pickaxe_heads").isVanilla(false).addValue(dullPickaxeHead.getId()));
                ...
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("pickaxe_heads/" + name).isVanilla(false).addValue(pickaxeHead.getId()));
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("pickaxe_heads").isVanilla(false).addValue(pickaxeHead.getId()));
                ...
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("hammer_heads/" + name).isVanilla(false).addValue(hammerHead.getId()));
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("hammer_heads").isVanilla(false).addValue(hammerHead.getId()));
                ...
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("dull_chisel_heads/" + name).isVanilla(false).addValue(dullChiselHead.getId()));
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("dull_chisel_heads").isVanilla(false).addValue(dullChiselHead.getId()));
                ...
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("chisel_heads/" + name).isVanilla(false).addValue(chiselHead.getId()));
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("chisel_heads").isVanilla(false).addValue(chiselHead.getId()));
            ...
            if(flag == TOOL_WEDGE){
                ...
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("wedges/" + name).isVanilla(false).addValue(wedge.getId()));
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("wedges").isVanilla(false).addValue(wedge.getId()));
            ...
            if(flag == TOOL_WEDGE_HANDLE){
                ...
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("wedge_handles/" + name).isVanilla(false).addValue(wedgeHandle.getId()));
                DataPackRegistry.saveItemTagData(DataPackRegistry.getItemTagData("wedge_handles").isVanilla(false).addValue(wedgeHandle.getId()));
