...
public class HoleRecipeBuilder {
    ...
    public HoleRecipeBuilder(IItemProvider desiredBlockIn, int minTicksIn, int maxTicksIn) {
        desiredBlock = desiredBlockIn.asItem();
        minTicks = minTicksIn;
        maxTicks = maxTicksIn;
    }

    public static HoleRecipeBuilder holeRecipe(IItemProvider desiredBlockIn, int minTicksIn, int maxTicksIn) {
    ...
    public void save(Consumer<IFinishedRecipe> p_200482_1_) {
        this.save(p_200482_1_, Registry.ITEM.getKey(this.result.getItem()));
    }
    ...
    public void save(Consumer<IFinishedRecipe> p_200485_1_, ResourceLocation p_200485_2_) {
        ...
        p_200485_1_.accept(new HoleRecipeBuilder.Result(p_200485_2_,
                this.group == null ? "" : this.group, desiredBlock, ingredientItems, ingredientItemDamage, consumeIngredients, minTicks, maxTicks, result, minResult, maxResult, holeColor,resinColor,
                this.advancement, new ResourceLocation(p_200485_2_.getNamespace(), "recipes/" + Objects.requireNonNull(this.result.getItem().getItemCategory()).getRecipeFolderName() + "/" + p_200485_2_.getPath())));
    }
    ...
    public static class Result implements IFinishedRecipe {
        ...
        public void serializeRecipeData(JsonObject jsonObject) {
            ...
            jsonObject.add("ingredient_items", jsonarray);
            ...
            jsonObject.addProperty("result_item", Registry.ITEM.getKey(this.result).toString());
