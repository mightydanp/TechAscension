...
//----------pickaxe
        {
            ...
            List<Either<String, ItemStack>> handlePartItems = new ArrayList<>();
            List<Either<String, ItemStack>> headPartItems = new ArrayList<>();
            List<Either<String, ItemStack>> bindingPartItems = new ArrayList<>();
