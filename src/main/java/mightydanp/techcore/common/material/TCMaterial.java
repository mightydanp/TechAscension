            ...
            if (flag == ORE || flag == GEM || flag == STONE_LAYER) {
                if (flag == STONE_LAYER) {
                    ...
                    //String resourceID = useMinecraftResource ? "" : Ref.mod_id;
                    {
                        ...
                        model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "block/ore/state/ore")))
                    ...
                    }
                    {
                        ...
                        model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "block/ore/state/small_ore")))
                                .texture("particle", new ResourceLocation(stoneLayerModId, stoneLayerBlock)).texture("sourceblock", new ResourceLocation(stoneLayerModId, stoneLayerBlock)));
                        AssetPackRegistry.blockModelDataMap.put(modelName, model);
                    }
                    {
                        ...
                        model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "block/ore/state/dense_ore")))
                                .texture("particle", new ResourceLocation(stoneLayerModId, stoneLayerBlock)).texture("sourceblock", new ResourceLocation(stoneLayerModId, stoneLayerBlock)));
                        AssetPackRegistry.blockModelDataMap.put(modelName, model);
                    }
//--//--//--//--//--//--//--//--//
                    {
                        ...
                        }
                        {
                            ...
                            model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "block/stone_layer/state/rock")))
                        ...
                        //--Resources
                        {
                            ...
                            model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "item/material_icons/" + textureIcon.getSecond().getName() + "/rock"))));
                        ...
                        }
                        {
                            ...
                            model.overrideModel(model.getModel().setParent(TAModelBuilder.ExistingItemModels.item_generated.model)
...
//--//--//--//--//--//--//--//--//
                    {
                        ...
                        }
                        {
                            ...
                            model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "block/stone_layer/state/thin_slab")))
                        ...
                        {
                            ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                            model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "block/stone_layer/thin_slab/thin_" + name + "_slab"))));
                            AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                        }
...
//--//--//--//--//--//--//--//--//
                    {
                        ...
                        {
                            ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                            model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "item/material_icons/" + textureIcon.getSecond().getName() + "/crushed_ore"))));
                            AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                        }
                        {
...
//--//--//--//--//--//--//--//--//
                    {
                        ...
                        {
                            ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                            model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "item/material_icons/" + textureIcon.getSecond().getName() + "/purified_ore"))));
                            AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                        }
                        {
...
//--//--//--//--//--//--//--//--//
                    {
                        ...
                        {
                            ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                            model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "item/material_icons/" + textureIcon.getSecond().getName() + "/centrifuged_ore"))));
                            AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                        }
                        {
...
//--//--//--//--//--//--//--//--//
                    {
                        ...
                        {
                            ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                            model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "item/material_icons/" + textureIcon.getSecond().getName() + "/gem"))));
                            AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                        }
                        {
...
//--//--//--//--//--//--//--//--//
                    {
                        ...
                        {
                            ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                            model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "item/material_icons/" + textureIcon.getSecond().getName() + "/chipped_gem"))));
                            AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                        }
                        {
...
//--//--//--//--//--//--//--//--//
                    {
                        ...
                        {
                            ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                            model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "item/material_icons/" + textureIcon.getSecond().getName() + "/flawed_gem"))));
                            AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                        }
                        {
...
//--//--//--//--//--//--//--//--//
                    {
                        ...
                        {
                            ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                            model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "item/material_icons/" + textureIcon.getSecond().getName() + "/flawless_gem"))));
                            AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                        }
                        {
...
//--//--//--//--//--//--//--//--//
                    {
                        ...
                        {
                            ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                            model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "item/material_icons/" + textureIcon.getSecond().getName() + "/legendary_gem"))));
                            AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                        }
                        {
...
//--//--//--//--//--//--//--//--//
                {
                    ...
                    {
                        ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                        model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "item/material_icons/" + textureIcon.getSecond().getName() + "/dust"))));
                        AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                    }
                    {
...
//--//--//--//--//--//--//--//--//
                {
                    ...
                    {
                        ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                        model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "item/material_icons/" + textureIcon.getSecond().getName() + "/small_dust"))));
                        AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                    }
                    {
...
//--//--//--//--//--//--//--//--//
                {
                    ...
                    {
                        ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                        model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "item/material_icons/" + textureIcon.getSecond().getName() + "/tiny_dust"))));
                        AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                    }
                    {
...
//--//--//--//--//--//--//--//--//
                        {
                            ...
                            //--Resources
                            {
                                ...
                                model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "item/material_icons/" + textureIcon.getSecond().getName() + "/raw_ore")))
                                );
                                ...
                                model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation("item/generated")))
                            ...
                            {
                                ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                                model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "block/ore/" + stoneLayer.name + "_ore"))));
                                AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                            }
...
//--//--//--//--//--//--//--//--//
                        {
                            ...
                            {
                                ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                                model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "block/small_ore/" + "small_" + stoneLayer.name + "_ore"))));
                                AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                            }
                            enLang.addTranslation("item." + Ref.mod_id + "." + objectName, LangData.translateUpperCase(objectName));
                            //--Tags
...
//--//--//--//--//--//--//--//--//
                        {
                            ...
                            {
                                ModelData model = new ModelData(objectName, ModelData.ITEM_FOLDER, null);
                                model.overrideModel(model.getModel().setParent(new ModelFile.UncheckedModelFile(new ResourceLocation(Ref.mod_id, "block/dense_ore/" + "dense_" + stoneLayer.name + "_ore"))));
                                AssetPackRegistry.itemModelDataHashMap.put(objectName, model);
                            }
                            enLang.addTranslation("item." + Ref.mod_id + "." + objectName, LangData.translateUpperCase(objectName));
                            //--Tags
