...
/**
 * Helper class for converting maps to NBT/json/etc and back using mojang's codec library.
...
/* from Commoble
 * @ https://github.com/Commoble/databuddy/blob/1.16.3/src/main/java/commoble/databuddy/codec/MapCodecHelper.java
 */
...
public class MapCodecHelper
{
    ...
    protected static <KEY,VALUE> Codec<Pair<KEY,VALUE>> getSafePairCodec(Codec<KEY> keyCodec, Codec<VALUE> valueCodec)
    {
        return RecordCodecBuilder.create(instance ->
                instance.group(
                        keyCodec.fieldOf("k").forGetter(Pair::getFirst),
                        valueCodec.fieldOf("v").forGetter(Pair::getSecond)
